...
public class NewFolderWithALongNameTest implements IAbstractTest {
    @MethodOwner(owner = "edgar")
    @Test(description = "Can not  a new folder with a long name, it is a bug")
    public void newFolderWithALongNameTest(){
        ...
        createOrEditAFolderPage.typeFolderName(R.TESTDATA.get("longFolderName"));
        createOrEditAFolderPage.clickSaveButton();
        Assert.assertTrue(createOrEditAFolderPage.checkErrorCreatedMessage(),"The error message did not appear");
    }
}
