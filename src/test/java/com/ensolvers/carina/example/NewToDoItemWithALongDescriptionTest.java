...
public class NewToDoItemWithALongDescriptionTest implements IAbstractTest {
    @MethodOwner(owner = "edgar")
    @Test(description = "New to do Item with a really long description, it is a bug")
    public void newToDoItemWithALongDescriptionTest(){
        ...
        createOrEditAToDoItemPage.typeDescription(R.TESTDATA.get("longDescription"));
