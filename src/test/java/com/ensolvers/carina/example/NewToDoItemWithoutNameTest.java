...
public class NewToDoItemWithoutNameTest implements IAbstractTest {
    @MethodOwner(owner = "edgar")
    @Test(description = "New to do Item without a name, it is a bug")
    public void newToDoItemWithoutNameTest(){
