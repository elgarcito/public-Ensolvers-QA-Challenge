...
public class CreateNewFolderWithoutNameTest implements IAbstractTest {
    @MethodOwner(owner = "edgar")
    @Test(description = "Create a new folder without a name, it is a bug")
    public void createNewFolderWithoutNameTest(){
